...
BEDROCK = tex_coords((0,2),(0,2),(0,2))
DIAMOND_ORE = tex_coords((1,2),(1,2),(1,2))
    ...
    def _initialize(self):
        ...
        for x in xrange(-n, n + 1, s):
            for z in xrange(-n, n + 1, s):
                ...
                self.add_block((x, y - 5, z), BEDROCK, immediate=False)
                if x in (-n, n) or z in (-n, n):
                    # create outer walls.
                    for dy in xrange(-10, 250):
        ...
        for _ in xrange(120):
            ...
            t = random.choice([GRASS, SAND, BRICK,DIRT])
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inventory = [BRICK, GRASS, SAND,WOOD,DIRT,STONE,DIAMOND_ORE]
        """FORINVENTORY"""
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if self.exclusive:
            ...
            if (button == mouse.RIGHT) or \
                ...
                if texture != BEDROCK:##Bedrock is undestructable
